    ...
    return (
        <Wrapper>
            ...
            <Kategorie>
                ...
                <Items>
                  <Img src={play_arrow} onClick={(event)=>{setDeveloper(!developer);setShape(developer,event) }} ></Img>
                    <input type="checkbox" className='ing' name="" id="develope"/>
                    <Label style={{marginLeft:'8px'}} for='develope'>개발</Label>
                </Items>
              {developer&&<> 
              <div>
              ...
              <KategoriItems id='web' text='웹'/>
                ...
                <Img src={play_arrow} onClick={(event)=>{setdesinger(!desinger);setShape(desinger,event) }}></Img>
                    <input type="checkbox" className='ing' name="" id="design"/>
                    <Label  style={{marginLeft:'8px'}}for='design'>디자인</Label>
                </Items>
